...
export const ProfileBarSm = ({ searchBtnHandler }) => {
    const [isOpen, setIsOpen] = useOutsideModalClose(`.${Styles.profile_icon}`)
    ...
    return (
        <div className={`col-4 col-sm-6 text-end ${Styles.profile_icon} ${Styles.search_field}`}>
            ...
            <FontAwesomeIcon className='icon' icon={faUser} onClick={() => setIsOpen(prev => !prev)} />
            {/* User profile dropdown */}
            {isOpen && <div className={`dropdown ${Styles.user_profile_dropdown}`}>
